...
<ul class="category thumbnail-widget">
<li class="category-title thumb-content">men</li>
    <li><a href="#" class="footer-link thumb-content">t-shirts</a></li>
    <li><a href="#" class="footer-link thumb-content">sweatshirts</a></li>
    <li><a href="#" class="footer-link thumb-content">shirts</a></li>
    <li><a href="#" class="footer-link thumb-content">jeans</a></li>
    <li><a href="#" class="footer-link thumb-content">trousers</a></li>
    <li><a href="#" class="footer-link thumb-content">shoes</a></li>
    <li><a href="#" class="footer-link thumb-content">casuals</a></li>
    <li><a href="#" class="footer-link thumb-content">formals</a></li>
    <li><a href="#" class="footer-link thumb-content">sports</a></li>
    <li><a href="#" class="footer-link thumb-content">watch</a></li>
</ul>
</div>
</div>
...
<ul class="category thumbnail-widget">
    <li class="category-title thumb-content">Women</li>
    <li><a href="#" class="footer-link thumb-content">t-shirts</a></li>
    <li><a href="#" class="footer-link thumb-content">sweatshirts</a></li>
    <li><a href="#" class="footer-link thumb-content">shirts</a></li>
    <li><a href="#" class="footer-link thumb-content">jeans</a></li>
